python trojan_detector.py --learned_parameters_dirpath=./learned_parameters_first_2_layers  --model_filepath=/home/jmfan/packages/trojan-ai/trojai-datasets/round10-train-dataset/models/id-00000003/model.pt  --result_filepath=./output.txt  --scratch_dirpath=./scratch/  --examples_dirpath=/home/jmfan/packages/trojan-ai/trojai-datasets/round10-train-dataset/models/id-00000108/clean-example-data.json  --round_training_dataset_dirpath=/path/to/training/dataset/ --source_dataset_dirpath ../trojai-datasets/coco2017/trojai_coco/  --metaparameters_filepath=./metaparameters.json  --schema_filepath=./metaparameters_schema.json
