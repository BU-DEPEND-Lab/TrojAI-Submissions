...
if __name__ == "__main__":
    ...
    parser.add_argument('--container-filepath', type=str, help='The filepath to the singularity container.', default = './example_trojan_detector.simg')
    parser.add_argument('--jsonschema-filepath', type=str, help='The filepath to the jsonschema.', default = './metaparameters_schema.json')
    parser.add_argument('--config-filepath', type=str, help="The filepath to the program's configuration file", default = './metaparameters.json')
