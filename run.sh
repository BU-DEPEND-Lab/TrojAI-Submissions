...
then 
    ...
    then
        ...
        --model_filepath ~/Workspace/TrojAI-Submissions/model/id-00000047/model.pt \
        --result_filepath ./output.txt \
        --scratch_dirpath ./scratch \
        --examples_dirpath ~/Workspace/TrojAI-Submissions/model/id-00000047/clean-example-data/ \
