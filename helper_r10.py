...
def get_paths(id,root='../trojai-datasets/round10-train-dataset'):
    id='id-%08d'%id;
...
def get_root(id,root='../trojai-datasets/round10-train-dataset'):
    id='id-%08d'%id;
    return os.path.join(root,'models',id);

def load_trigger(id,root='../trojai-datasets/round10-train-dataset'):
    id='id-%08d'%id;
