python trojan_detector.py --learned_parameters_dirpath=./learned_parameters  --model_filepath=/mnt/md0/shared/TrojAI-Submissions/trojai-datasets/round11/image-classification-sep2022-example-source-dataset  --metaparameters_filepath=./metaparameters.json  --schema_filepath=./metaparameters_schema.json
