python trojan_detector.py --learned_parameters_dirpath=./learned_parameters  --model_filepath=/mnt/md0/shared/TrojAI-Submissions/trojai-datasets/round11/models/id-00000003/model.pt  --result_filepath=./output.txt  --scratch_dirpath=./scratch/  --examples_dirpath=/mnt/md0/shared/TrojAI-Submissions/trojai-datasets/round11/models/id-00000108/clean-example-data.json  --round_training_dataset_dirpath=/mnt/md0/shared/TrojAI-Submissions/trojai-datasets/round11/models --source_dataset_dirpath /mnt/md0/shared/TrojAI-Submissions/trojai-datasets/round11/coco2017/trojai_coco/  --metaparameters_filepath=./metaparameters.json  --schema_filepath=./metaparameters_schema.json
